...
public abstract class FragmentGuestBinding extends ViewDataBinding {
  ...
  protected FragmentGuestBinding(DataBindingComponent _bindingComponent, View _root,
  ...
  public abstract void setHandler(@Nullable GuestCheckoutHandler handler);
  ...
  @NonNull
  public static FragmentGuestBinding inflate(@NonNull LayoutInflater inflater,
  ...
  public static FragmentGuestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<FragmentGuestBinding>inflate(inflater, webkul.opencart.mobikul.R.layout.fragment_guest, root, attachToRoot, component);
  }
  ...
  public static FragmentGuestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<FragmentGuestBinding>inflate(inflater, webkul.opencart.mobikul.R.layout.fragment_guest, null, false, component);
  }

  public static FragmentGuestBinding bind(@NonNull View view) {
    return bind(view, DataBindingUtil.getDefaultComponent());
  }

  public static FragmentGuestBinding bind(@NonNull View view,
      @Nullable DataBindingComponent component) {
    return (FragmentGuestBinding)bind(component, view, webkul.opencart.mobikul.R.layout.fragment_guest);
  }
}
