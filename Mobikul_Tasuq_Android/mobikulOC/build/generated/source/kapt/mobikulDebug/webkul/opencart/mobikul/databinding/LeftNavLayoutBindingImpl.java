...
public class LeftNavLayoutBindingImpl extends LeftNavLayoutBinding implements webkul.opencart.mobikul.generated.callback.OnClickListener.Listener {
    ...
    public LeftNavLayoutBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private LeftNavLayoutBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.leftNavLl.setTag(null);
        this.mboundView0 = (android.widget.RelativeLayout) bindings[0];
        this.mboundView0.setTag(null);
        setRootTag(root);
        // listeners
        mCallback29 = new webkul.opencart.mobikul.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.categoryName, dataCategoryName);
        }
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1

            this.leftNavLl.setOnClickListener(mCallback29);
        }
    }
